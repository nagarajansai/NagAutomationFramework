...
public class AddColumnXlsxFile {

	public static Logger logger = Logger.getLogger(AddColumnXlsxFile.class);

	String fileLoc = "C:\\Nagarajan\\ExcelAutDoc\\";
	String fileName = "LoginData.xlsx";
	
	String fileNameNew = "LoginDataAddColumn.xlsx";
	...
	public void writeExcel(String fileLoc, String fileName, String sheetName, String string) {
		...
		try {
			...
			Workbook getWb = new XSSFWorkbook(fis);
			Workbook writeWb = new XSSFWorkbook();
			XSSFSheet sheet = (XSSFSheet) getWb.getSheet(sheetName);
			XSSFSheet newSheet = (XSSFSheet) writeWb.createSheet(sheetNameNew);
